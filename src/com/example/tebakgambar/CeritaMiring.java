...
public class CeritaMiring extends Activity {
	//deklarasi variabel
		EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cerita_miring);
	...
	public void CekJawaban(View v){
    	String jawabanBenar = "CERITA MIRING";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(), DaurUlang.class);
    		startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cerita_miring, menu);
		return true;
	}
