...
public class SumpahPocong extends Activity {
	//deklarasi variabel
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sumpah_pocong);
	 ...
	 public void CekJawaban(View v){
	    	String jawabanBenar = "SUMPAH POCONG";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), SuratTilang.class);
	    		startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sumpah_pocong, menu);
		return true;
	}
