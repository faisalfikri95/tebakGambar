...
public class PertikaianSeru extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pertikaian_seru);
	 ...
	 public void CekJawaban(View v){
	    	String jawabanBenar = "PERTIKAIAN SERU";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pertikaian_seru, menu);
		return true;
	}
