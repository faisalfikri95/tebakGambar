...
public class LahanDiBakar extends Activity {
	//deklarasi variabel
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lahan_di_bakar);
	 ...
	 public void CekJawaban(View v){
	    	String jawabanBenar = "LAHAN DIBAKAR";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), MintaUang.class);
	    		startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.lahan_di_bakar, menu);
		return true;
	}
