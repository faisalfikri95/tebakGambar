...
public class JawabanPolos extends Activity {
	//deklarasi variabel
			EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jawaban_polos);
	 ...
	 public void CekJawaban(View v){
	    	String jawabanBenar = "JAWABAN POLOS";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), LahanDiBakar.class);
	    		startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jawaban_polos, menu);
		return true;
	}
